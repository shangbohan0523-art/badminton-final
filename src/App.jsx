...
const PRO_PLAYERS = [
  { 
    ...
    gender: 'M', 
    style: '全能控制 / 变速突击', 
    attrs: { attr_power: 9, attr_speed: 9, attr_endurance: 9, attr_mentality: 10, attr_forehand: 9, attr_backhand: 8, attr_attack: 10, attr_defense: 9 },
    honors: ['两届奥运会男单冠军 (2008, 2012)', '五届世锦赛男单冠军', '全英赛六冠王'],
    description: '羽毛球历史上的GOAT。早期以极具爆发力的“变速突击”打法统治赛场，后期转型为“太极控制”打法，拥有无与伦比的球商和大赛心态。你的风格与他相似，意味着你在场上拥有极强的统治力和适应能力。',
    quote: '只有坚持到最后的人，才能看到对手倒下。'
  },
  { 
    name: '李宗伟', 
    gender: 'M', 
    style: '极致速度 / 弹簧腿', 
    attrs: { attr_power: 7, attr_speed: 10, attr_endurance: 9, attr_mentality: 7, attr_forehand: 9, attr_backhand: 8, attr_attack: 10, attr_defense: 8 },
    honors: ['三届奥运会男单银牌', '保持世界排名第一周数纪录 (376周)', '47个超级赛冠军'],
    description: '以鬼魅般的步伐和极致的突击速度著称。他的防守反击能力极强，能在被动中通过轻巧的假动作和极快的启动速度扭转局势。你像他一样，是球场上的“法拉利”。',
    quote: '败者为王，永不言弃。'
  },
  { 
    name: '陶菲克', 
    gender: 'M', 
    style: '反手天才 / 网前魔术', 
    attrs: { attr_power: 7, attr_speed: 7, attr_endurance: 6, attr_mentality: 8, attr_forehand: 8, attr_backhand: 10, attr_attack: 8, attr_defense: 7 },
    honors: ['奥运会男单冠军 (2004)', '世锦赛男单冠军 (2005)', '亚运会男单金牌'],
    description: '羽坛反手天花板，拥有教科书般的反手杀球和细腻的网前手感。他打球潇洒写意，经常能打出令人匪夷所思的神仙球。你的反手和网前技术是你最大的武器。',
    quote: '天赋是上天给的，但风格是自己创造的。'
  },
  { 
    name: '安赛龙', 
    gender: 'M', 
    style: '立体进攻 / 铁壁防守', 
    attrs: { attr_power: 10, attr_speed: 7, attr_endurance: 9, attr_mentality: 9, attr_forehand: 9, attr_backhand: 7, attr_attack: 10, attr_defense: 8 },
    honors: ['奥运会男单冠军 (2020)', '世锦赛男单冠军', '巡回赛收割机'],
    description: '拥有绝对的身高优势和极具威胁的下压进攻。近年来练就了密不透风的防守能力，成为难以被攻破的“高塔”。你的进攻势大力沉，让对手感到窒息。',
    quote: '每一次杀球都是对胜利的渴望。'
  },
  { 
    name: '傅海峰', 
    gender: 'M', 
    style: '麒麟臂 / 重炮手', 
    attrs: { attr_power: 10, attr_speed: 8, attr_endurance: 8, attr_mentality: 9, attr_forehand: 9, attr_backhand: 6, attr_attack: 10, attr_defense: 7 },
    honors: ['四届世锦赛男双冠军', '两届奥运会男双冠军', '杀球时速纪录保持者'],
    description: '左手重炮，后场进攻能力处于人类巅峰。他的杀球不仅快而且重，是双打中最可靠的后场输出点。你像他一样，是队伍中的核武器。',
    quote: '唯有进攻，才能掌握命运。'
  },
  { 
    name: '戴资颖', 
    gender: 'F', 
    style: '假动作大师 / 魔术师', 
    attrs: { attr_power: 6, attr_speed: 8, attr_endurance: 8, attr_mentality: 7, attr_forehand: 10, attr_backhand: 9, attr_attack: 8, attr_defense: 6 },
    honors: ['亚运会女单金牌', '全英赛冠军', '世界排名第一时长纪录'],
    description: '羽坛魔术师，假动作极多，球路诡谲莫测。她不需要绝对的力量就能通过节奏变化把对手晃倒。你的打法充满灵性，看你打球是一种享受。',
    quote: '快乐打球，享受比赛。'
  },
  { 
    name: '安洗莹', 
    gender: 'F', 
    style: '天才防守 / 磨王', 
    attrs: { attr_power: 7, attr_speed: 8, attr_endurance: 10, attr_mentality: 9, attr_forehand: 8, attr_backhand: 8, attr_attack: 7, attr_defense: 10 },
    honors: ['世锦赛女单冠军', '亚运会双冠王', '天才少女'],
    description: '拥有令人绝望的防守能力和跑动耐力。无论球在何处，她似乎总能救起来并高质量回球。你的防守和韧性是对手的噩梦。',
    quote: '只要球没落地，比赛就没有结束。'
  },
  { 
    name: '陈雨菲', 
    gender: 'F', 
    style: '大帝稳健 / 拉吊突击', 
    attrs: { attr_power: 7, attr_speed: 8, attr_endurance: 9, attr_mentality: 10, attr_forehand: 8, attr_backhand: 8, attr_attack: 7, attr_defense: 9 },
    honors: ['奥运会女单冠军 (2020)', '苏迪曼杯主力', '全运会卫冕冠军'],
    description: '技术全面，失误极少，打法极其稳健。她在场上如同定海神针，擅长通过拉吊消耗对手，并在关键时刻给出致命一击。',
    quote: '稳住心态，就能赢下一切。'
  },
  { 
    name: '马林', 
    gender: 'F', 
    style: '狮子吼 / 极速进攻', 
    attrs: { attr_power: 9, attr_speed: 10, attr_endurance: 8, attr_mentality: 9, attr_forehand: 9, attr_backhand: 7, attr_attack: 10, attr_defense: 7 },
    honors: ['奥运会女单冠军 (2016)', '三届世锦赛女单冠军', '欧洲女皇'],
    description: '以极快的速度和凶悍的进攻著称，标志性的吼叫代表了她强烈的求胜欲。你的球风彪悍，气势逼人。',
    quote: '在场上，我就是女王。'
  },
];
...
export default function App() {
  ...
  return (
    <div className="h-[100dvh] bg-slate-950 text-white font-sans relative overflow-hidden flex flex-col touch-manipulation">
      ...
      {view !== 'match' && (
        <header className="relative z-20 px-4 pt-10 pb-3 flex justify-between items-center bg-slate-950/80 backdrop-blur border-b border-white/5 shrink-0">
          <h1 onClick={()=>setView('lobby')} className="text-2xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-300 cursor-pointer">SMASH.</h1>
          <button onClick={()=>setExpenseModal(true)} className="bg-white/5 p-2 rounded-full hover:bg-white/10"><Wallet size={20} className="text-emerald-400"/></button>
        </header>
      )}

      <main className={`relative z-10 w-full flex-1 overflow-y-auto overflow-x-hidden px-3 pt-4 pb-32`}>
        
        {/* 1. 大厅 */}
        {view === 'lobby' && (
          <div className="h-full flex flex-col">
            <div className="flex justify-between items-center mb-4">
                 <div className="flex gap-1 bg-slate-900 p-1 rounded-xl border border-white/10"><button onClick={()=>setLobbyTab('player')} className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${lobbyTab==='player'?'bg-emerald-500 text-white shadow':'text-slate-400 hover:text-white'}`}>选手</button><button onClick={()=>setLobbyTab('pair')} className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${lobbyTab==='pair'?'bg-emerald-500 text-white shadow':'text-slate-400 hover:text-white'}`}>组合</button></div>
                 <div className="flex gap-2"><button onClick={() => setIsManageMode(!isManageMode)} className={`p-2 rounded-full ${isManageMode ? 'bg-emerald-500 text-white' : 'bg-white/10 text-white/60'}`}><Settings size={20} /></button><button onClick={() => setPlayerModal({ show: true, type: 'add' })} className="bg-white/10 p-2 rounded-full text-emerald-400"><UserPlus size={20} /></button></div>
            </div>
            ...
            {lobbyTab === 'player' ? (
                ...
                {stats.player.map(p => {
                  ...
                  return (
                    <div key={p.id} className="relative group" onClick={() => !isManageMode && (isSel ? setSelectedPlayers(prev => prev.filter(id=>id!==p.id)) : selectedPlayers.length < 4 && setSelectedPlayers(prev=>[...prev, p.id]))}>
                      <div className={`w-full p-3 rounded-2xl border flex items-center gap-4 transition-all shadow-md active:scale-95 ${isSel ? 'bg-emerald-500/10 border-emerald-400 ring-1 ring-emerald-400/50' : 'bg-slate-800/40 border-white/5'} ${isManageMode ? 'opacity-60' : ''}`}>
                        <Avatar name={p.name} colorIdx={p.avatar_idx} size="sm"/>
                        <div className="text-left flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1"><span className="font-bold text-white truncate text-base">{p.name}</span><span className="text-[10px] font-black bg-yellow-500/20 text-yellow-400 px-1.5 py-0.5 rounded">{p.rating}</span></div>
                          <div className="text-xs text-white/40 flex items-center gap-2"><span>{p.team_name}</span>{p.similarPro && <span className="text-emerald-400/70 bg-emerald-500/5 px-1 rounded flex items-center gap-0.5 z-20"><Star size={10}/> {p.similarPro.name}</span>}</div>
                          <RecentForm results={p.recent} />
                        </div>
                        {/* FIX 1: 个人信息入口按钮优化，不再白板 */}
                        <button onClick={(e)=>{e.stopPropagation(); setRadarModal({show:true, data:p})}} className="p-2 bg-slate-700/50 text-emerald-400 hover:bg-emerald-500 hover:text-white rounded-full z-20 transition-colors border border-white/5"><Info size={20}/></button>
                      ...
                      {/* FIX 2: 新增删除按钮 */}
                      {isManageMode && (
                        <div className="absolute inset-0 flex items-center justify-center gap-3 bg-slate-900/80 backdrop-blur-sm rounded-2xl z-30">
                          <button onClick={(e) => {e.stopPropagation(); setPlayerModal({ show: true, type: 'edit', data: p })}} className="p-3 bg-blue-500 rounded-full shadow-xl hover:scale-110 transition-transform text-white"><Edit2 size={20} /></button>
                          <button onClick={(e) => {e.stopPropagation(); handleDeletePlayer(p.id)}} className="p-3 bg-red-500 rounded-full shadow-xl hover:scale-110 transition-transform text-white"><Trash2 size={20} /></button>
                        </div>
                      )}
                    </div>
                  )
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 pb-20">
                 {stats.pair.length > 0 ? stats.pair.map(pair => (
                    <div key={pair.id} className="bg-slate-800/40 border border-white/5 rounded-2xl p-3 flex items-center gap-3 relative group" onClick={()=>setRadarModal({show:true, data:pair, isPair:true})}>
                       <div className="flex -space-x-2"><Avatar name={pair.p1?.name} colorIdx={pair.p1?.avatar_idx} size="xs"/><Avatar name={pair.p2?.name} colorIdx={pair.p2?.avatar_idx} size="xs"/></div>
                       <div className="flex-1 min-w-0">
                          <div className="text-sm font-bold text-white truncate">{pair.name}</div>
                          <div className="text-xs text-white/40">{pair.matches}场比赛</div>
                          <RecentForm results={pair.recent} />
                       </div>
                       <div className="text-right"><div className="text-emerald-400 font-black text-lg">{pair.rating}</div><div className="text-[8px] text-white/30">积分</div></div>
                       <button onClick={(e)=>{e.stopPropagation(); setRadarModal({show:true, data:pair, isPair:true})}} className="absolute top-3 right-3 p-1 text-emerald-400/50 hover:text-emerald-400"><Info size={16}/></button>
                       {isManageMode && <div className="absolute inset-0 bg-slate-900/80 flex items-center justify-center rounded-2xl backdrop-blur-sm text-xs text-white/60">组合数据由历史比赛生成<br/>无法直接删除</div>}
                    </div>
          ...
          <div className="space-y-6 pb-24">
            ...
            <div className="flex flex-col gap-4">
               <div className="flex justify-between items-center">
                 ...
                 <div className="flex items-center gap-2"><select className="bg-slate-900 border border-white/10 rounded-lg text-xs p-1.5 outline-none text-white/80 max-w-[120px]" value={currentSeasonId} onChange={(e)=>setCurrentSeasonId(e.target.value)}><option value="all">全部赛季</option>{seasons.map(s=><option key={s.id} value={s.id}>{s.name}</option>)}</select><button onClick={()=>setSeasonModal(true)} className="p-1.5 bg-white/10 rounded-lg"><Plus size={14}/></button></div>
               </div>
               <div className="flex bg-slate-900 p-1 rounded-xl border border-white/10 overflow-x-auto no-scrollbar"><TabBtn active={rankTab==='player'} onClick={()=>setRankTab('player')} icon={<Users size={14}/>} label="个人" /><TabBtn active={rankTab==='team'} onClick={()=>setRankTab('team')} icon={<Shield size={14}/>} label="队伍" /><TabBtn active={rankTab==='pair'} onClick={()=>setRankTab('pair')} icon={<Users size={14}/>} label="组合" /><TabBtn active={rankTab==='rising'} onClick={()=>setRankTab('rising')} icon={<TrendingUp size={14}/>} label="飙升" /></div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {rankTab === 'player' && stats.player.map((p, i) => (<div key={p.id} className="bg-slate-800/50 border border-white/5 rounded-2xl p-3 flex items-center gap-3" onClick={()=>setRadarModal({show:true, data:p})}><div className={`w-6 text-center font-black text-lg ${i<3?'text-yellow-400':'text-white/20'}`}>{i+1}</div><Avatar name={p.name} colorIdx={p.avatar_idx} size="sm" /><div className="flex-1 min-w-0"><div className="font-bold text-white truncate">{p.name}</div><RecentForm results={p.recent} /></div><div className="text-right"><div className="text-emerald-400 font-black text-lg">{p.score}</div><div className="text-[10px] text-white/30">PTS</div></div></div>))}
              ...
              {rankTab === 'pair' && stats.pair.map((t, i) => (<div key={t.id} className="bg-slate-800/50 border border-white/5 rounded-2xl p-3 flex items-center gap-3" onClick={()=>setRadarModal({show:true, data:t, isPair:true})}><div className={`w-6 text-center font-black text-lg ${i<3?'text-yellow-400':'text-white/20'}`}>{i+1}</div><div className="flex -space-x-2"><Avatar name={t.p1?.name} colorIdx={t.p1?.avatar_idx} size="xs"/><Avatar name={t.p2?.name} colorIdx={t.p2?.avatar_idx} size="xs"/></div><div className="flex-1 min-w-0"><div className="font-bold text-white text-sm truncate">{t.name}</div><RecentForm results={t.recent} /></div><div className="text-right"><div className="text-emerald-400 font-black text-lg">{t.score}</div><div className="text-[10px] text-white/30">PTS</div></div></div>))}
              {rankTab === 'rising' && stats.rising.map((p, i) => (<div key={p.id} className="bg-slate-800/50 border border-white/5 rounded-2xl p-3 flex items-center gap-3" onClick={()=>setRadarModal({show:true, data:p})}><div className="text-emerald-400 font-bold text-lg w-6">+{p.score}</div><Avatar name={p.name} colorIdx={p.avatar_idx} size="sm"/><div className="flex-1"><div className="font-bold text-white">{p.name}</div><div className="text-xs text-white/40">近5场</div></div><TrendingUp className="text-red-400" size={18} /></div>))}
            </div>
          </div>
        )}
      ...
      {/* FIX 3: 个人信息模态框 (RadarModal) - 补充更多信息 */}
